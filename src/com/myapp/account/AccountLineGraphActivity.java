...
import com.myapp.account.graph.AccountPaymentLineGraphImpl;
import com.myapp.account.utility.Utility;
import com.myapp.account.observer.ClickObserverInterface;

/**
 * @brief AccountLineGraph Activity Class.
 */
public class AccountLineGraphActivity extends Activity implements ClickObserverInterface {
    ...
    protected void init() {
        ...
        this.currentGraph = new AccountPaymentLineGraphImpl(this, (LinearLayout)findViewById(R.id.current_flipper));
        this.nextGraph = new AccountPaymentLineGraphImpl(this, (LinearLayout)findViewById(R.id.next_flipper));
    ...
    protected void displayGraphTitle() {
        ...
        String title = Utility.splitYear(this.currentDate) + getText(R.string.payment_line_chart_title_suffix).toString();
    ...
    protected void setCurrentDate(float velocity_x) {
        if( velocity_x < 0 ) {
            this.currentDate = Utility.getNextYearDate(currentDate);
        } else {
            this.currentDate = Utility.getPreviousYearDate(currentDate);
        }
    }
